...
<template>
  <div class="flex max-h-screen">
    ...
    <div class="w-full gap-4">
      ...
      <div  class="h-[94%] w-full bg-[#E8F8EF] grid grid-cols-8 grid-rows-6">
        ...
        <div class="col-span-5 row-span-2 bg-white m-4 mb-2 mr-2 rounded-[12px] p-4">
          ...
          <div class="flex w-full h-full items-center ">
            ...
            <div class="flex w-[50%] align-center items-center border-l-2 border-[#16B559] justify-center gap-5" @click="handleRoute('courses')">
              <UIcon 
                name="i-tabler-report" 
                class="w-20 h-20 text-center text-[#017C35]" 
              />
              <h1 class="text-[#017C35] text-md font-medium">
                DEPARTMENTAL <br>SUMMARY</h1>
            </div>
        ...
        <div class="col-span-3 row-span-3 bg-white m-4 ml-2 rounded-[12px] p-4">
          <h1 class="text-[#017C35] font-bold text-xl">Track Summary Approval</h1>
        </div>
        
        <div class="col-span-5 row-span-4 bg-white m-4 mt-2 mr-2 mb-2 rounded-[12px] p-4">
          <h1 class="text-[#017C35] font-bold text-xl">SUMMARY HISTORY</h1>
        </div>
        
        <div class="col-span-3 row-span-3 bg-white m-4 ml-2 mt-2 rounded-[12px] p-4">
